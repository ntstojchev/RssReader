...
#
# Created: Fri Jun  8 19:14:27 2012
...
class Ui_FeedForm(object):
    def setupUi(self, FeedForm):
        ...
        self.gridLayout.addWidget(self.txtFeedItems, 3, 0, 1, 5)
    ...
    def retranslateUi(self, FeedForm):
        ...
        self.btnExport.setText(QtGui.QApplication.translate("FeedForm", "Export", None, QtGui.QApplication.UnicodeUTF8))
